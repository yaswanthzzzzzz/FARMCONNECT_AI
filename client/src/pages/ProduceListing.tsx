...
import LocationCapture, { type CapturedLocation } from "@/components/farmconnect/LocationCapture";
...
export default function ProduceListing() {
  ...
  const [capturedLocation, setCapturedLocation] = useState<CapturedLocation>({ source: "manual" });
