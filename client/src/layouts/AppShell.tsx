  ...
  return <div className="min-h-screen bg-[#fbfcf8] text-[#18332a]">
    <header className="sticky top-0 z-40 border-b border-[#e6ede1]/90 bg-[#fbfcf8]/95 backdrop-blur-xl">
      <div className="container flex h-[72px] items-center justify-between gap-5">
        ...
        <div className="hidden items-center gap-3 lg:flex"><Link href="/farmer/produce" className="text-sm font-semibold text-[#426650] hover:text-[#1b5e3c]">List produce</Link><ActionButton href="/farmer" size="sm">Open workspace <ArrowRight size={15} /></ActionButton></div>
